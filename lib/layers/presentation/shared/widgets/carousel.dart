...
class CarouselItem {
  ...
  CarouselItem({required this.image, this.title});
}
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: AnimatedContainer(
                              ...
                              width:
                                  double.parse(listItem.value.width.toString()),
                              height: useHeight,
                              child: Stack(
                                fit: StackFit.expand,
                                children: [
                                  ...
                                  if (listItem.value.childData.title != null)
                                    Container(
